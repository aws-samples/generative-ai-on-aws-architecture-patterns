...
st.set_page_config(page_title="RAG bot - An LLM-powered chatbot")
...
def refresh():
    ...
    st.session_state['generated'] = ["Hi, I'm RAG bot. I'm connected to a knowledge base. How may I help you?"]
